...
public class PasswordCheckerTest {
	...
	public void setUp() throws Exception {
		String[] p = { "334455BB#", "george2ZZZ#", "4Sal#", "bertha22", "august30", "a2cDe", "ApplesxxxYYzz#", "aa11Bb",
				"pilotProject", "AAAbb@123" };
	...
	/**
	 * Checks if the password is less than 8 characters long and throw an exception if not
	 * 
	 */
	@Test
	...
	/**
	 * Test if the password contains at least one uppercase alpha character and throw an exception if not
	...
	/**
	 * Test if the password contains at least one lowercase alpha character and throw an exception if not
	 * 
	 */
	@Test
	...
	/**
	 * Test if the password is weak throw an exception if so
	 */
	@Test
	...
	/**
	 * Test if the password contains more than 2 of the same character in sequence 
	 */
	@Test
	...
	/**
	 * Test the getInvalidPasswords method Check the results of the Arraylist
	 * 
	 */
	@Test
